...
app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
  ...
  .when('/home', {
    templateUrl: "/assets/index-605be418aa9516aaec984d4cd9f3c4a9.html"
  })
  .when('/search', {
    controller: 'CentreController',
    templateUrl: "/assets/main-function-page-2a6b0bbe16936741503bb24b5c6ba0c3.html"
  })
  .when('/profile', {
    controller: 'ProfileController',
    templateUrl: "/assets/my-profile-e11ea4f16bfbab23db73ffa19961fb24.html"   
    })
  .when('/profile/:id', {
    controller: 'UserProfileController',
    templateUrl: "/assets/user-profile-f681358cd4272d8daf7698c9309c6c0d.html"  
    })
  .when('/phone', {
    controller: 'PhoneController',
    templateUrl: "/assets/phone-88686c775f3e35be0bf2af4c06da8c6e.html"
  })
  .when('/users/all_users', {
    controller: 'AllUsersController',
    templateUrl: "/assets/all-users-8fb03f73e4517c1aaa7dc571d5e0180c.html"
  })
  .when('/match', {
    controller: 'MatchController',
    templateUrl: "/assets/match-cc0022137a0f736b0c617b3d5cfb6b22.html"
  })
  .otherwise({
    redirectTo: '/landing'
  });
...
// $scope.clickToOpenMatch = function () {
  ...
  ngDialog.open({ 
    templateUrl: "/assets/booking-confirmation-db082ddf1e97b5356cb497426a35e40b.html",
    scope: $scope,
