...
var app = angular.module('SquinderApp', ['ngRoute', 'ngAnimate', 'ngMap', 'ngDialog']);

app.value( 'gps', { 
  userLat: '51.520151399999996',
  userLon: '-0.0704819'
});
...
app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
  ...
  .when('/home', {
    templateUrl: "/assets/.-c5ba55a2de5ae650269b0a14ff361ec23a9bd57f2d19f7bf5b4129da7ed9183d.html"
  })
  .when('/search', {
    controller: 'CentreController',
    templateUrl: "/assets/main-function-page-ce3a7c7fccb3fc9c92fbc306f112d382e11999c6541f11afb9349c20c3c2121a.html"
  })
  .when('/profile', {
    controller: 'ProfileController',
    templateUrl: "/assets/my-profile-c3e0a22bfad65a0a48ad125d5aa767ce5c315d7d943bd45b2274c7ab6fabc1cb.html"   
    })
  .when('/profile/:id', {
    controller: 'UserProfileController',
    templateUrl: "/assets/user-profile-b8c20250133731fa7cf6d047ecc13a0b5caf33c54060c7aee09e996224a0c931.html"  
    })
  .when('/phone', {
    controller: 'PhoneController',
    templateUrl: "/assets/phone-7e50ec8a13a997475cf8899b48521a16f9e315ef7b1e89af74e33802b6cbf8e4.html"
  })
  .when('/users/all_users', {
    controller: 'AllUsersController',
    templateUrl: "/assets/all-users-34acf0c68e54deead907b3bd885c74b7e0535c7ddf5db81bf5970591f8ec2d5e.html"
  })
  .when('/match', {
    controller: 'MatchController',
    templateUrl: "/assets/match-c28f6121e8619e19c30d1d565ec86037eb53f96071da20a539e103f73674b008.html"
  })
  .otherwise({
    redirectTo: '/home'
  });
...
//   ngDialog.open({ 
//     templateUrl: "/match-confirmation.html",
//     scope: $scope,
//     appendTo: "body"
//   });
//  }
...
// $scope.clickToOpenMatch = function () {
  function clickToOpenMatch() {
  // $scope.modalArtist = artist;
  ngDialog.open({ 
    templateUrl: "/assets/booking-confirmation-8ca491ed76ac6906fc5b23140ba471566c73ce88c6720264732a34eac179e81a.html",
    scope: $scope,
...
app.controller('MatchController', ['$scope', '$http', '$routeParams', 'ProfileService', 'CourtService', 'UserService', function($scope, $http, $routeParams, ProfileService, CourtService, UserService){
...
// app.filter('abilty', function () {
//   return function (t) {
//     if (t.dist < 5 && t.level == current_user.level && time == time_variable) {
//       return t
//     } else if {
